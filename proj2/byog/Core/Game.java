...
public class Game {
    ...
    public void playWithKeyboard() {
        ...
        if (input == 'n') {
            long seed = inputSeed();
            world = new World(new Random(seed), WIDTH, HEIGHT);
        } else if (input == 'l') {
            world = loadGame();
        } else if (input == 'q') {
            System.exit(0);
