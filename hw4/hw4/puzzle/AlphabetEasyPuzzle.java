...
/**
 * Ultra simple puzzle useful for debugging. The puzzle has a state equal
 * to a single alphabetical lower case character. The goal is 'z'.
 * Neighbors are the characters immediately to the left and right
